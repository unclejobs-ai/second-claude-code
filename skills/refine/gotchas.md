...
**Symptom**: The target score is never reached and refinement continues indefinitely
...
**Symptom**: Refine state is lost after the session ends
**Fix**: Save state to `refine-active.json` after every iteration and restore it next session.

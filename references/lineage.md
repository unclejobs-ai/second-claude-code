...
**Absorbed**: The PARA classification system (Projects, Areas, Resources, Archives) drives the `/scc:collect` skill. The CODE cycle (Capture, Organize, Distill, Express) maps directly to the collect-to-write pipeline.
...
**Absorbed**: Record-Reduce-Recombine patterns power the capture and knowledge synthesis flow. Queue orchestration concepts inform how `/scc:workflow` sequences skill invocations. The 3-spaces model (personal, shared, public) guides output destination logic.

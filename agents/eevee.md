...
When fetching a specific URL and `WebFetch` returns 4xx/5xx, an under-200-char body, a content-type mismatch, or a known challenge body (Cloudflare, captcha, etc.), run the **unblock chain** instead of retrying with raw curl:

...
- **Deep Interview** — `/scc:deep-interview`, `skills/deep-interview/`, `scripts/deep-interview-runner.mjs`가 Round 0 topology 확인, 모호성 점수, ontology 수렴, 언어 보존 명세, 내부 auto-mode fragment, 승인 게이트 핸드오프를 갖춘 소크라테스식 요구사항 인터뷰를 제공합니다.

...
3. Length negotiation activates: article format minimum is 4,000 chars of body, user requested ~800 words. The skill informs the user and offers alternatives.

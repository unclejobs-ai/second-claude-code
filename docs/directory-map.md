...
│   ├── README.md                  # Human map
│   ├── architecture.md            # Runtime boundary + roster (tree lives in this file, not there)
...
├── daemon/companion-daemon.mjs    # Companion daemon entry (lib lives in hooks/lib/)
├── benchmarks/loop/               # Loop-runner suite manifests
├── references/                    # Maintainer methodology notes (mmbridge, consensus, …)
├── evals/                         # claude plugin eval routing suite; results/ gitignored
